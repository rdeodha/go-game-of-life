...
func (g *Game) Draw(screen *ebiten.Image) {
	...
	//ebitenutil.DrawRect(screen, float64(-36), float64(100), 5, 5, color.White)
	ebitenutil.DebugPrint(screen, fmt.Sprintf("X: %d ---- Y: %d", xC, yC))
	// ebitenutil.DrawRect(screen, float64(xC), float64(yC), 20, 50, color.White)
}
